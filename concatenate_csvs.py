...
def main():
    parser = argparse.ArgumentParser(
        ...
        epilog="""
Examples:
    python concatenate_csvs.py usefatt/exp_20_results_ort_beta_0_5 output/combined.csv
    python concatenate_csvs.py folder1 folder2 folder3 output/combined.csv --sort
    python concatenate_csvs.py usefatt/exp_20_results_ort_beta_0_5 usefatt/exp_21_results_ort_beta_0_5 output/all_combined.csv --sort
        """
    )
    parser.add_argument(
        "input_folders",
